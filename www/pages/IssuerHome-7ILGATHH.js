...
window.MHR.register("IssuerHome", class extends window.MHR.AbstractPage {
  constructor(id) {
    super(id);
  }
  async enter() {
...
function logonScreen() {
  console.log("In Logon", pb.authStore.model);
  var commonName;
  if (pb.authStore.isValid) {
    commonName = pb.authStore.model.commonName;
  }
  return html`
    <ion-card>
        <ion-card-header>
        ...
        <ion-card-content>
            ...
            <div class="ion-margin-top">
            <ion-text class="ion-margin-top">You need to register and verify your email before being able to logon and use this system.</ion-text>
            </div>
