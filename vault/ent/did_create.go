...
func (dc *DIDCreate) SetJwk(b []byte) *DIDCreate {
	dc.mutation.SetJwk(b)
	return dc
}

// SetPem sets the "pem" field.
func (dc *DIDCreate) SetPem(b []byte) *DIDCreate {
	dc.mutation.SetPem(b)
	return dc
}
...
func (dc *DIDCreate) SetAlg(s string) *DIDCreate {
	dc.mutation.SetAlg(s)
	return dc
}

// SetKeyusage sets the "keyusage" field.
func (dc *DIDCreate) SetKeyusage(s string) *DIDCreate {
	dc.mutation.SetKeyusage(s)
	return dc
}
...
func (dc *DIDCreate) check() error {
	if _, ok := dc.mutation.Jwk(); !ok {
		return &ValidationError{Name: "jwk", err: errors.New(`ent: missing required field "DID.jwk"`)}
	}
	if _, ok := dc.mutation.Pem(); !ok {
		return &ValidationError{Name: "pem", err: errors.New(`ent: missing required field "DID.pem"`)}
	}
	if _, ok := dc.mutation.Alg(); !ok {
		return &ValidationError{Name: "alg", err: errors.New(`ent: missing required field "DID.alg"`)}
	}
	if _, ok := dc.mutation.Keyusage(); !ok {
		return &ValidationError{Name: "keyusage", err: errors.New(`ent: missing required field "DID.keyusage"`)}
	}
	if _, ok := dc.mutation.CreatedAt(); !ok {
...
func (dc *DIDCreate) createSpec() (*DID, *sqlgraph.CreateSpec) {
	...
	if value, ok := dc.mutation.Jwk(); ok {
	...
	if value, ok := dc.mutation.Pem(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeBytes,
			Value:  value,
			Column: did.FieldPem,
	...
	if value, ok := dc.mutation.Alg(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: did.FieldAlg,
	...
	if value, ok := dc.mutation.Keyusage(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: did.FieldKeyusage,
		})
