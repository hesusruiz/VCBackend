...
func ID(id string) predicate.NaturalPerson {
	return predicate.NaturalPerson(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}

// IDEQ applies the EQ predicate on the ID field.
func IDEQ(id string) predicate.NaturalPerson {
	return predicate.NaturalPerson(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDGT(id string) predicate.NaturalPerson {
	return predicate.NaturalPerson(func(s *sql.Selector) {
...
func IDLT(id string) predicate.NaturalPerson {
	return predicate.NaturalPerson(func(s *sql.Selector) {
...
func Name(v string) predicate.NaturalPerson {
	return predicate.NaturalPerson(func(s *sql.Selector) {
...
func Type(v string) predicate.NaturalPerson {
	return predicate.NaturalPerson(func(s *sql.Selector) {
...
func And(predicates ...predicate.NaturalPerson) predicate.NaturalPerson {
	return predicate.NaturalPerson(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Or(predicates ...predicate.NaturalPerson) predicate.NaturalPerson {
	return predicate.NaturalPerson(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Not(p predicate.NaturalPerson) predicate.NaturalPerson {
	return predicate.NaturalPerson(func(s *sql.Selector) {
		p(s.Not())
	})
}
