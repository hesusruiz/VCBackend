...
func (pkq *PublicKeyQuery) GroupBy(field string, fields ...string) *PublicKeyGroupBy {
	grbuild := &PublicKeyGroupBy{config: pkq.config}
...
func (pkq *PublicKeyQuery) Select(fields ...string) *PublicKeySelect {
	...
	selbuild := &PublicKeySelect{PublicKeyQuery: pkq}
	selbuild.label = publickey.Label
...
func (pkq *PublicKeyQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (pkgb *PublicKeyGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (pkgb *PublicKeyGroupBy) sqlQuery() *sql.Selector {
...
func (pks *PublicKeySelect) Scan(ctx context.Context, v interface{}) error {
	...
	pks.sql = pks.PublicKeyQuery.sqlQuery(ctx)
	return pks.sqlScan(ctx, v)
}

func (pks *PublicKeySelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
