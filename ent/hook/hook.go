...
// The DIDFunc type is an adapter to allow the use of ordinary
// function as DID mutator.
type DIDFunc func(context.Context, *ent.DIDMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DIDFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.DIDMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DIDMutation", m)
	}
	return f(ctx, mv)
}

// The NaturalPersonFunc type is an adapter to allow the use of ordinary
// function as NaturalPerson mutator.
type NaturalPersonFunc func(context.Context, *ent.NaturalPersonMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f NaturalPersonFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.NaturalPersonMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.NaturalPersonMutation", m)
	}
	return f(ctx, mv)
}
...
// Mutate calls f(ctx, m).
func (f PrivateKeyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
...
func (f WebauthnCredentialFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.WebauthnCredentialMutation)
	if !ok {
