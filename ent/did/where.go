...
func Privatekey(v []byte) predicate.DID {
	return predicate.DID(func(s *sql.Selector) {
...
func PrivatekeyEQ(v []byte) predicate.DID {
	return predicate.DID(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldPrivatekey), v))
	})
}
...
func PrivatekeyNEQ(v []byte) predicate.DID {
	return predicate.DID(func(s *sql.Selector) {
...
func PrivatekeyIn(vs ...[]byte) predicate.DID {
...
func PrivatekeyNotIn(vs ...[]byte) predicate.DID {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PrivatekeyGT(v []byte) predicate.DID {
	return predicate.DID(func(s *sql.Selector) {
...
func PrivatekeyGTE(v []byte) predicate.DID {
	return predicate.DID(func(s *sql.Selector) {
...
func PrivatekeyLT(v []byte) predicate.DID {
	return predicate.DID(func(s *sql.Selector) {
...
func PrivatekeyLTE(v []byte) predicate.DID {
	return predicate.DID(func(s *sql.Selector) {
