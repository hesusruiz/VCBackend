...
func (du *DIDUpdate) SetPrivatekey(b []byte) *DIDUpdate {
	du.mutation.SetPrivatekey(b)
	return du
}
...
func (du *DIDUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := du.mutation.Privatekey(); ok {
...
// SetPrivatekey sets the "privatekey" field.
func (duo *DIDUpdateOne) SetPrivatekey(b []byte) *DIDUpdateOne {
	duo.mutation.SetPrivatekey(b)
	return duo
}
...
func (duo *DIDUpdateOne) sqlSave(ctx context.Context) (_node *DID, err error) {
	...
	if value, ok := duo.mutation.Privatekey(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeBytes,
			Value:  value,
			Column: did.FieldPrivatekey,
