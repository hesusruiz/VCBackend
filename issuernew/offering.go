            ...
            <div class="half-centered">
                ...
                <div class="w3-panel">
                    ...
                    <div class="w3-card w3-panel">
                        ...
                        <p>You can <a href="{{crosswallet}}"" target=" _blank">click here to see the credential</a>
                    ...
                    <div class="w3-card w3-panel">
                        ...
                        <figure class="w3-margin">
                            ...
                            <figcaption>Getting the Wallet: Scan the QR code above with your mobile camera or type <b>www.mycredential.eu</b> in the browser in your mobile.</figcaption>
                          </figure>
...
func templateOfferingParse(credentialRecord *models.Record, walletQRcode, credentialQRcode, credentialHref, credURIsameDevice string) string {

	t := fasttemplate.New(templateOffering, "{{", "}}")
	html := t.ExecuteString(map[string]any{
		"walletqrcode":     walletQRcode,
		"credentialqrcode": credentialQRcode,
		"crosswallet":      credentialHref,
		"directlink":       credURIsameDevice,
