...
var templateLEARCredentialEmail = `
...
<body>
	...
	<p>
		<a class="btn" href="{{issuerurl}}/apiuser/startissuancepage/{{credential_id}}" target="_blank" rel="noo=pener">Go to MyCredential.eu portal</a>
	</p>
	<p>Or click the following link:
	<a href="{{issuerurl}}/apiuser/startissuancepage/{{credential_id}}" target="_blank" rel="noo=pener">
		{{issuerurl}}/apiuser/startissuancepage/{{credential_id}}
	</a>
	<p>
		Thanks,<br />
...
func (is *IssuerServer) sendLEARCredentialEmail(credId string) error {
	app := is.App
